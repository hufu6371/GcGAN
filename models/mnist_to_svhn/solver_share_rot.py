...
class Solver(object):
    ...
    def get_gc_loss(self, AB, AB_gc, direction):
        loss_gc = 0.0
    ...
    def train(self, svhn_test_loader, mnist_test_loader):
        ...
        for step in range(self.train_iters+1):
            ...
            gc_loss_A = self.get_gc_loss(fake_svhn, fake_svhn_gc, 0)
            g_loss += gc_loss_A
            ...
            gc_loss_B = self.get_gc_loss(fake_mnist, fake_mnist_gc, 0)
            g_loss += gc_loss_B
            ...
            if (step+1) % 5000 == 0:
                ...
                #g12_gc_path = os.path.join(self.model_path, 'g12_gc-%d.pkl' %(step+1))
                #g21_gc_path = os.path.join(self.model_path, 'g21_gc-%d.pkl' %(step+1))
                ...
                #torch.save(self.g12_gc.state_dict(), g12_gc_path)
